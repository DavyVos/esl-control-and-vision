...
/* Note: Alias variables are the result of full optimization
   ...
   XXDouble tilt_variables[NUMBER_VARIABLES + NUMBER_ALIAS_VARIABLES + 1];
...
#pragma optimize("", off)
#endif
void TiltodelInitialize_parameters(void)
{
	/* set the parameters */
...
void TiltodelInitialize_initialvalues(void)
{
...
void TiltodelInitialize_states(void)
{
	/* set the states */
...
void TiltodelInitialize_variables(void)
{
